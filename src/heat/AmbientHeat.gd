...
@export_range(0.0, 37.0, 0.005, "or_greater") var target_heat: float = 24.0
...
## temperature in 1 second. Do the math.
@export_range(0.0, 0.1, 0.00001, "or_greater") var rate: float = 0.001
